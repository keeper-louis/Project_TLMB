...
namespace ZQC.K3.TLMB.SalBack.BusinessPlugin
{
    [Description("销售退货单库存状态改变")]
    public class SalBackStateChange : AbstractOperationServicePlugIn
    {
        //库存状态对象
        ...
        public override void BeginOperationTransaction(BeginOperationTransactionArgs e)
        {
            ...
            {//FSTOCKSTATUSID库存状态  编码  07040000 07040004
                if (entity != null)
                {
                    ...
                    DynamicObjectCollection entityInfo = entity["SAL_RETURNSTOCKENTRY"] as DynamicObjectCollection;
