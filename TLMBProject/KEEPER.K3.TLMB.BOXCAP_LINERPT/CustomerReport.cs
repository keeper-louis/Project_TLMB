...
{
    [Description("客户箱套统计表")]
    public class CustomerReport:SysReportBaseService
    {
        ...
        public override void Initialize()
        {
            ...
            base.ReportProperty.ReportName = new LocaleValue("客户箱套统计表", this.Context.UserLocale.LCID);   //报表名称
        }
        /// <summary>
        /// 报表动态表头构建
        /// </summary>
        ...
        public override ReportHeader GetReportHeaders(IRptParams filter)
        {
            ...
            var QY = header.AddChild("F_PAEZ_XL", new LocaleValue("客户"));
            QY.ColIndex = 0;
            var LXQIKC = header.AddChild("F_PAEZ_LXQQKC", new LocaleValue("绿箱&前期库存"));
            LXQIKC.ColIndex = 1;
            var LXBQFC = header.AddChild("F_PAEZ_LXFXZFX", new LocaleValue("绿箱&线路发箱"));
            LXBQFC.ColIndex = 2;
            var LXBQFX = header.AddChild("F_PAEZ_LXFZXS", new LocaleValue("绿箱&返线箱数"));
            LXBQFX.ColIndex = 3;
            ...
            BXQIKC.ColIndex = 6;
            var BXBQFC = header.AddChild("F_PAEZ_BXFXZFX", new LocaleValue("白箱&线路发箱"));
            BXBQFC.ColIndex = 7;
            var BXBQFX = header.AddChild("F_PAEZ_BXFZXS", new LocaleValue("白箱&返线箱数"));
            BXBQFX.ColIndex = 8;
